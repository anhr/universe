...
//Build circularUniverse.module.min.js
//https://www.npmjs.com/package/uglify-es
const UglifyJS = require( "uglify-es" ),
    code = fs.readFileSync(path.join(__dirname, 'build/hyperSphericalUniverse.module.js' ), "utf8" ),
...
export default Object.assign({}, defaultConfig, {
  output: [{
    ...
    exports: 'named',
      file: './build/hyperSphericalUniverse.min.js',
    format: 'umd',
