...
//Build sphericalUniverse.module.min.js
//https://www.npmjs.com/package/uglify-es
const UglifyJS = require("uglify-es");
let code = fs.readFileSync(path.join(__dirname, 'build/sphericalUniverse.module.js' ), "utf8" ),
    result = UglifyJS.minify( code );
if ( result.error !== undefined )
    console.log( result.error ); // runtime error, or `undefined` if no error
else fs.writeFileSync( "build/sphericalUniverse.module.min.js", result.code, "utf8" );

code = fs.readFileSync(path.join(__dirname, 'build/sphericalUniverse.js'), "utf8");
result = UglifyJS.minify(code);
if (result.error !== undefined)
    console.log(result.error); // runtime error, or `undefined` if no error
else fs.writeFileSync("build/sphericalUniverse.min.js", result.code, "utf8");
